...
describe("parse returns null", function () {
  it("with no input", () => expect(number.parse("", formats.en)).toBe(null));
  ...
  it("with overflow", () =>
    expect(number.parse("234234234234234234234234234234234", formats.en)).toBe(
      null
    ));

  it("with decimal overflow", () =>
    expect(
      number.parse("123.234234234234234234234234234234234", formats.en)
    ).toBe(null));
});

describe("extract returns null", function () {
  it("with no input", () => expect(number.extract("", formats.en)).toBe(null));
...
describe("extract is ok", function () {
  ...
  it("with en groups and decimals", () =>
    expect(number.extract("abc -1,345,678.9 def", formats.en)).toBe(
      -1345678.9
    ));
  it("with de groups and decimals", () =>
    expect(number.extract("abc -1.345.678,9 def", formats.de)).toBe(
      -1345678.9
    ));
  it("with cz groups and decimals", () =>
    expect(number.extract("abc -1 345 678,9 def", formats.cz)).toBe(
      -1345678.9
    ));
});

describe("handles interesting numbers is ok", function () {
  it("accounting format", () =>
    expect(number.extract("(123.4)", formats.en)).toBe(-123.4));
  it("bp", () => expect(number.extract("12bp", formats.en)).toBe(12 / 1e4));
  it("bp negative", () =>
    expect(number.extract("12bp", formats.en)).toBe(-12 / 1e4));
  it("mult", () => expect(number.extract("5x", formats.en)).toBe(5));
});
